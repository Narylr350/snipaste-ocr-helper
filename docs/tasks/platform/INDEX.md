...
`platform` is part of the initial `snipaste-ocr-helper` scaffold. The initial docs define the app as a C#/.NET Windows desktop utility with WPF recommended for the first tray-and-settings implementation.
