...
- 2026-05-06: App icon validation passed: executable, settings window, and tray icon all reference `Assets/AppIcon.ico`; full solution tests passed with 29 tests, 0 failures; Release build and publish succeeded.
